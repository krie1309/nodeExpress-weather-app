...
const getInfo = async (event) => {
    ...
    if (cityVal === "") {
        ...
        try {
            ...
            let api_key = '467d2572ab3f824e0d8664c1ef721f5b';
            ...
            datahide.classList.add("data_hide");
            city_name.innerText = `${cityVal.toUpperCase()}: Not found in API.\nInvalid Data!!\nor Please make sure that you are connected to an Internet connection.`;
